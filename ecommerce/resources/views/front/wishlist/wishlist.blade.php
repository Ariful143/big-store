    ...
    <div class="check-out">
        <div class="container">
            ...
            <table class="table ">
                ...
                <tr class="cross">
                    <td class="ring-in t-data">
                        <a href="{{route('single')}}" class="at-in">
                            <img src="{{asset('/')}}big-store/images/wi.png" class="img-responsive" alt="">
                        </a>
                        <div class="sed">
                ...
                <tr class="cross1">
                    <td class="t-data ring-in"><a href="{{route('single')}}" class="at-in"><img src="{{asset('/')}}big-store/images/wi1.png" class="img-responsive" alt=""></a>
                        <div class="sed">
                            <h5>Sed ut perspiciatis unde</h5>
                        </div>
                        <div class="clearfix"> </div>
                ...
                <tr class="cross2">
                    <td class="t-data ring-in"><a href="{{route('single')}}" class="at-in"><img src="{{asset('/')}}big-store/images/wi2.png" class="img-responsive" alt=""></a>
                        <div class="sed">
                            <h5>Sed ut perspiciatis unde</h5>
                        </div>
                        <div class="clearfix"> </div>
