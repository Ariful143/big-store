...
@section('body')
    <div class="banner-top">
        <div class="container">
            <h3 >About</h3>
            <h4><a href="{{route('home')}}">Home</a><label>/</label>About</h4>
        ...
        <div class="container">
            <div  class="about">
                ...
                <div class="col-md-4 about-right">
                    <img class="img-responsive" src="{{asset('/')}}big-store/images/ab.jpg" alt="">
                </div>
                ...
                <div class="col-md-4 about-right">
                    <img class="img-responsive" src="{{asset('/')}}big-store/images/ab1.jpg" alt="">
                </div>
        ...
        <div class="container">
            <div class="advantages">
                <div class="col-md-6 advantages-left ">
                    ...
                    <div class="advn-one">
                        <div class="ad-mian">
                            ...
                            <div class="ad-right">
                                <h4><a href="{{route('single')}}">Elacus a porta varius dui</a></h4>
                ...
                <div class="col-md-6 advantages-left about-agi">
                    <h3>Our Skills</h3>
                    <div class="advn-two">
                        <h4><a href="{{route('single')}}"> eu tincidunt lacinia, elit quam ultri ces ipsum, quis ultricies ipsum ante</a></h4>
